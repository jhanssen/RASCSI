...
// // BOOL GPIOBUS_BPI::setup_raspberry_pi(void* map, int fd){
// // 		// GPIO
// // 	gpio = (DWORD *)map;
...
// // BOOL GPIOBUS_BPI::setup_banana_pi(void* map, int fd){
// // 		// GPIO
// // 	gpio = (DWORD *)map;
// // 	gpio += GPIO_OFFSET / sizeof(DWORD);
// // 	level = &gpio[GPIO_LEV_0];
...
// BOOL GPIOBUS_BPI::Init(mode_e mode)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetENB(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetBSY(bool ast)
// {
// 	// Set BSY signal
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetSEL(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetATN(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetACK(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetACT(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetRST(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetMSG(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetCD(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetIO(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetREQ(BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetDAT(BYTE dat)
// {
// 	// Write to port
...
// //
// //---------------------------------------------------------------------------
// int GPIOBUS_BPI::CommandHandShake(BYTE *buf, bool is_sasi)
// {
// 	int count;
...
// //
// //---------------------------------------------------------------------------
// int GPIOBUS_BPI::ReceiveHandShake(BYTE *buf, int count)
// {
// 	int i;
// 	BOOL ret;
// 	DWORD phase;
...
// //
// //---------------------------------------------------------------------------
// int GPIOBUS_BPI::SendHandShake(BYTE *buf, int count, int delay_after_bytes)
// {
// 	int i;
...
// //
// //---------------------------------------------------------------------------
// int GPIOBUS_BPI::PollSelectEvent()
// {
// 	// clear errno
// 	errno = 0;
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::ClearSelectEvent()
// {
// }
// #endif	// USE_SEL_EVENT_ENABLE
...
// //
// //---------------------------------------------------------------------------
// const int GPIOBUS_BPI::SignalTable[19] = {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::MakeTable(void)
// {
// 	const int pintbl[] = {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetControl(int pin, BOOL ast)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetMode(int pin, int mode)
// {
// #if SIGNAL_CONTROL_MODE == 0
// 	if (mode == OUT) {
// 		return;
...
// //
// //---------------------------------------------------------------------------
// BOOL GPIOBUS_BPI::GetSignal(int pin)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::SetSignal(int pin, BOOL ast)
// {
// #if SIGNAL_CONTROL_MODE == 0
// 	int index = pin / 10;
// 	int shift = (pin % 10) * 3;
...
// //
// //---------------------------------------------------------------------------
// BOOL GPIOBUS_BPI::WaitSignal(int pin, BOOL ast)
// {
// 	// Get current time
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::PinConfig(int pin, int mode)
// {
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::PullConfig(int pin, int mode)
// {
// 	DWORD pull;
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::PinSetSignal(int pin, BOOL ast)
// {
// 	// Check for invalid pin
// 	if (pin < 0) {
// 		return;
...
// //
// //---------------------------------------------------------------------------
// void GPIOBUS_BPI::DrvConfig(DWORD drive)
// {
...
// //
// //---------------------------------------------------------------------------
// BUS::phase_t GPIOBUS_BPI::GetPhaseRaw(DWORD raw_data)
// {
// 	// Selection Phase
...
// //
// //---------------------------------------------------------------------------
// int GPIOBUS_BPI::GetCommandByteCount(BYTE opcode) {
